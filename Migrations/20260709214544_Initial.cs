    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ING-SIS", "Ingeniería en Sistemas" },
                    { 2, "ADM-EMP", "Administración de Empresas" }
                });

            migrationBuilder.InsertData(
                table: "Cursos",
                columns: new[] { "Id", "CarreraId", "Codigo", "Creditos", "Nombre" },
                values: new object[,]
                {
                    { 1, 1, "SC-301", 4, "Estructuras de Datos" },
                    { 2, 1, "SC-220", 3, "Bases de Datos II" },
                    { 3, 2, "ADM-101", 3, "Introducción a la Administración" }
                });
